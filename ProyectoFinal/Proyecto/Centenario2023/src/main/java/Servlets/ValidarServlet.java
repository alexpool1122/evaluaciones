	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(accion.equalsIgnoreCase("iniciar")) {
			...
			if(empleado.getNomEmpleado() != null) {
				...
				request.setAttribute("bienvenido","<div id=\"myAlert\" class=\"alert alert-success\" role=\"alert\">\r\n"
						+ "	  			<h7> Hola "+empleado.getNomEmpleado()+" Se Bienvenido(a) a tu horario laboral</h7>\r\n"
						+ "	  		</div> <script>\r\n"
						+ "	  var alertElement = document.getElementById(\"myAlert\");\r\n"
						+ "	  var tiempoVisible = 4000;\r\n"
						+ "\r\n"
