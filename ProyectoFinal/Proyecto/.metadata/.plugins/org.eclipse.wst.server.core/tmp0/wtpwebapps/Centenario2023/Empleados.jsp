					...
					<div class="card-body">
						...
						<form action="Controlador?menu=Empleado" method="post">
							...
							<div class="mb-2">
								...
								<input type="email" class="form-control h-50" name="txtCorreo" value="${empleadoSeleccionado.getCorreoEmpleado()}"  id="correo" placeholder="Ingrese Correo del Empleado" title="Ingrese un número decimal válido">
							</div>
							<div class="mb-2">
