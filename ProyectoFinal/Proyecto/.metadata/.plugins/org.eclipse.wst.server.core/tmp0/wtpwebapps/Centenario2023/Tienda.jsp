								...
								<div class="col-6">
									<div class="mb-2">
										...
										<select name="cboCategoria" class="form-select" aria-label="Default select example">
										  ...
										  <option value="Gaseosas" ${catSeleccionado == 'Gaseosas' ? 'selected' : ''}>Gaseosas</option>
										  <option value="Agua Mineral" ${catSeleccionado == 'Agua Mineral' ? 'selected' : ''}>Agua Mineral</option>
										  <option value="Energizantes" ${catSeleccionado == 'Energizantes' ? 'selected' : ''}>Energizantes</option>
										  <option value="Jugos" ${catSeleccionado == 'Jugos' ? 'selected' : ''}>Jugos</option>
										  <option value="Galletas" ${catSeleccionado == 'Galletas' ? 'selected' : ''}>Galletas</option>
										</select>
									</div>
								</div>
								<div class="col-6">
