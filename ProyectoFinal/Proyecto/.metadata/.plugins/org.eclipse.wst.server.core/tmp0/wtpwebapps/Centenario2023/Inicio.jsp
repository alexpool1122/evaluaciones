               		...
               		<div class="accordion accordion-flush" id="accordionFlushExample">
	                    ...
	                    <div class="accordion-item">
                			...
                			<div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
	                        	<div class="accordion-body">
									Es importante que nuestros clientes entiendan que a la empresa no solo le importa que se obtengan resultados, sino la manera en cómo se obtienen. Todos los empleados deben ser éticos entre ellos mismos, al igual que con los clientes, con los proveedores y con la competencia. La empresa espera el cumplimiento de sus normas en toda la organización y no tolerará que los empleados logren resultados a costa de la violación de las leyes.
	                        	</div>
	                      	</div>
	                    </div>
	                    <div class="accordion-item">
